...
class APImanager{
    ...
    //MARK: - ALLCOMPLETED_TASKLIST_API
    ...
    func callLogoutApi(completionHandler :@escaping Handler){
        //https://tgo.visilean.com/VisileanAPI/authenticate
        let ProjectListURL = "https://tgo.visilean.com/VisileanAPI/authenticate"
        
        AF.request(ProjectListURL, method: .delete, parameters: Parameters.init(),  headers: headers()).response{
